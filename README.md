...
| Name | Source | Version |
|------|--------|---------|
| <a name="module_iam_assumable_role_irsa_elastic_search"></a> [iam\_assumable\_role\_irsa\_elastic\_search](#module\_iam\_assumable\_role\_irsa\_elastic\_search) | terraform-aws-modules/iam/aws//modules/iam-assumable-role-with-oidc | 4.1.0 |
